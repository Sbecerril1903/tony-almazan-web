<section class="cta-bg pt-30 pb-30" >
    ...
    <div class="container" id="section_compras">
        ...
        <a class="btn" style="background-color: red;" href="https://tonyalmazan.com/assets/videos/cursos/_WorkbookTonyAlmazan.pdf"><i class='fas fa-file-pdf' style='font-size: 22px;'></i> Descargar Workbook</a>                   
    </div>
